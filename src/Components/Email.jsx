        ...
        <form className='text-center justify-center ' onSubmit={onSubmit}>
            ...
            <div className="flex">
                ...
                <motion.div whileInView={{opacity:1,x:0}} initial={{opacity:0,x:100}} transition={{duration:0.5}} className="w-1/2  mx-auto ">
                    <input className="flex me-3 rounded-sm text-black p-2 w-48 lg:w-80" type="text" placeholder='Enter your name' name='name' required/><br></br>
                    <input className="flex me-3 rounded-sm text-black p-2 w-48 lg:w-80" type="text" placeholder='Enter your Email' name='email' required/><br></br>
                    <textarea className="flex me-3 rounded-sm text-black w-48 p-2 lg:w-80" placeholder='Enter the message'  name='message' id="" required></textarea>
                </motion.div>
